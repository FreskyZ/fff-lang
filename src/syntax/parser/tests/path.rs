...
fn parse_primitive_type() {
    ...
    case!{ parse_type_ref "i32", |x| 
        make_type!(x prim 0:2 I32) }
}

#[test]
fn parse_array_type() {

    case!{ parse_type_ref "[i32; 5]", |x|
        make_type!(x array 0:7
            make_type!(x prim 1:3 I32),
            make_expr!(x i32 5 6:6)),
    }

    //      0         1         2
    //      01234567890123456789012345
    case!{ parse_type_ref "[[a;1]; 1 + 1 * 1 - 1 / 1]", |x|
        make_type!(x array 0:25
            make_type!(x array 1:5
                make_type!(x simple 2:2 #a),
                make_expr!(x i32 1 4:4)),
            make_expr!(x binary 8:24 Sub 18:18
                make_expr!(x binary 8:16 Add 10:10
                    make_expr!(x i32 1 8:8),
                    make_expr!(x binary 12:16 Mul 14:14
                        make_expr!(x i32 1 12:12),
                        make_expr!(x i32 1 16:16))),
                make_expr!(x binary 20:24 Div 22:22
                    make_expr!(x i32 1 20:20),
...
fn parse_tuple_type() {
    ...
    case!{ parse_type_ref "()", |x| make_type!(x tuple 0:1) }

    case!{ parse_type_ref "(i32, i32)", |x|
        make_type!(x tuple 0:9
            make_type!(x prim 1:3 I32),
            make_type!(x prim 6:8 I32)),
    }
...
fn parse_fn_type() {
    ...
    case!{ parse_type_ref "fn()", |x| make_type!(x fn 0:3 paren 2:3 []) }

    //      01234567890123456789
    case!{ parse_type_ref "fn() -> Result<T, E>", |x|
        make_type!(x fn ret 0:19 paren 2:3 [],
            make_type!(x path 8:19
    ...
    case!{ parse_type_ref "fn(i32, &string) -> i32", |x|
        make_type!(x fn ret 0:22 paren 2:15 [
            make_type!(x fp 3:5 make_type!(x prim 3:5 I32)),
            make_type!(x fp 8:14 make_type!(x ref 8:14 make_type!(x simple 9:14 #string)))],
            make_type!(x prim 20:22 I32)),
    }

    //      0          1          2          3
    //      0123 456789012345 678901234567 89012345678 9
    case!{ parse_type_ref "fn(\nthis: This,\nself: Self,\nthat: That,\n)", |x|
        make_type!(x fn 0:40 paren 2:40 [
    ...
    case!{ parse_type_ref "fn(argc: i32, argv: &string) -> i32", |x|
        make_type!(x fn ret 0:34 paren 2:27 [
            make_type!(x fp named 3:11 #argc 3:6 make_type!(x prim 9:11 I32)),
            make_type!(x fp named 14:26 #argv 14:17 make_type!(x ref 20:26 make_type!(x simple 21:26 #string)))],
            make_type!(x prim 32:34 I32)),
    }
    ...
    case!{ parse_type_ref "fn(this: &This, node: &/*dyn*/Node, title: string, span: Span, then: fn() -> Result<&This, fmt::Error>) -> fmt::Result", |x|
        make_type!(x fn ret 0:117 paren 2:102 [
            make_type!(x fp named 3:13 #this 3:6
                make_type!(x ref 9:13 make_type!(x simple 10:13 #This))),
            make_type!(x fp named 16:33 #node 16:19
                make_type!(x ref 22:33 make_type!(x simple 30:33 #Node))),
            ...
            make_type!(x fp named 63:101 #then 63:66
                make_type!(x fn ret 69:101 paren 71:72 [],
                    make_type!(x path 77:101
                        make_path!(x segment generic 77:101 #Result 77:82 quote 83:101
                            make_type!(x ref 84:88 make_type!(x simple 85:88 #This)),
                            make_type!(x path 91:100
                                make_path!(x segment simple 91:93 #fmt),
                                make_path!(x segment simple 96:100 #Error)))))),
        ], make_type!(x path 107:117
    ...
    case!{ parse_type_ref "fn(input: &string, f: F, expect_node: N, expect_diagnostics: crate::diagnostics::Diagnostics, expect_strings: &string, backtrace: u32) -> Result<(), (N, N, SourceContext<VirtualFileSystem>)>", |x|
        make_type!(x fn ret 0:189 paren 2:133 [
            make_type!(x fp named 3:16 #input 3:7
                make_type!(x ref 10:16 make_type!(x simple 11:16 #string))),
            ...
            make_type!(x fp named 94:116 #expect_strings 94:107
                make_type!(x ref 110:116 make_type!(x simple 111:116 #string))),
            make_type!(x fp named 119:132 #backtrace 119:127
                make_type!(x prim 130:132 U32)),
        ], make_type!(x path 138:189
            make_path!(x segment generic 138:189 #Result 138:143 quote 144:189
                make_type!(x tuple 145:146),
                make_type!(x tuple 149:188
                    make_type!(x simple 150:150 #N),
                    make_type!(x simple 153:153 #N),
                    make_type!(x path 156:187
    ...
    case!{ parse_type_ref "fn(argc,            &string) -> i32", |x|
        make_type!(x fn ret 0:34 paren 2:27 [
            make_type!(x fp 3:6 make_type!(x simple 3:6 #argc)),
            make_type!(x fp 20:26 make_type!(x ref 20:26 make_type!(x simple 21:26 #string)))],
            make_type!(x prim 32:34 I32)),
    }
    ...
    case!{ parse_type_ref "fn(argc: i32,        string) -> i32", |x|
        make_type!(x fn ret 0:34 paren 2:27 [
            make_type!(x fp named 3:11 #argc 3:6 make_type!(x prim 9:11 I32)),
            make_type!(x fp 21:26 make_type!(x simple 21:26 #string))],
            make_type!(x prim 32:34 I32)),
    }
    ...
    case!{ parse_type_ref "fn(argc: i32,       string,) -> i32", |x|
        make_type!(x fn ret 0:34 paren 2:27 [
            make_type!(x fp named 3:11 #argc 3:6 make_type!(x prim 9:11 I32)),
            make_type!(x fp 20:25 make_type!(x simple 20:25 #string))],
            make_type!(x prim 32:34 I32)),
    }
    ...
    case!{ parse_type_ref "fn(ns1::ns2::t)", |x|
        make_type!(x fn 0:14 paren 2:14 [
            make_type!(x fp 3:13
    ...
    case!{ parse_type_ref "fn(ns1<t1, t2>::t)", |x|
        make_type!(x fn 0:17 paren 2:17 [
            make_type!(x fp 3:16
                make_type!(x path 3:16
    ...
    case!{ parse_type_ref "fn(x3Kv: [Mc; 6326], &((&t6絩ru卒oLy, i64, &f64, u64), fn(Ak: [o7k81A6; 0x5Ad0Cc], OmNaGmqc: [g63凈N;  223], bOars,), [c6eFq8M;  636353.456], [b; 271]), f3,) -> [HrH70sp; 0d447231]", |x|
        make_type!(x fn ret 0:182 paren 2:159 [
            make_type!(x fp named 3:18 #x3Kv 3:6
                make_type!(x array 9:18
                    make_type!(x simple 10:11 #Mc),
                    make_expr!(x i32 6326 14:17))),
            make_type!(x fp 21:153
                make_type!(x ref 21:153 make_type!(x tuple 22:153
                    make_type!(x tuple 23:54
                        make_type!(x ref 24:37
                            make_type!(x simple 25:37 #t6絩ru卒oLy)),
                        make_type!(x prim 40:42 I64),
                        make_type!(x ref 45:48
                            make_type!(x prim 46:48 F64)),
                        make_type!(x prim 51:53 U64)),
                    make_type!(x fn 57:118 paren 59:118 [
                        make_type!(x fp named 60:82 #Ak 60:61
                            make_type!(x array 64:82
                                make_type!(x simple 65:71 #o7k81A6),
                                make_expr!(x i32 0x5Ad0Cc 74:81))),
                        make_type!(x fp named 85:109 #OmNaGmqc 85:92
                            make_type!(x array 95:109
                                make_type!(x simple 96:102 #g63凈N),
                                make_expr!(x i32 223 106:108))),
                        make_type!(x fp 112:116
                            make_type!(x simple 112:116 #bOars)),
                    ]),
                    make_type!(x array 121:142
                        make_type!(x simple 122:128 #c6eFq8M),
                        make_expr!(x r64 636353.4560000001 132:141)),
                    make_type!(x array 145:152
                        make_type!(x simple 146:146 #b),
                        make_expr!(x i32 271 149:151))))),
            make_type!(x fp 156:157
                make_type!(x simple 156:157 #f3)),
        ], make_type!(x array 164:182
            make_type!(x simple 165:171 #HrH70sp),
            make_expr!(x i32 447231 174:181)))
    }
}
...
fn parse_ref_type() {
    ...
    case!{ parse_type_ref "&()", |x|
        make_type!(x ref 0:2
            make_type!(x tuple 1:2))
    }
    ...
    case!{ parse_type_ref "&&i32", |x|
        make_type!(x ref 0:4
            make_type!(x ref 1:4
                make_type!(x prim 2:4 I32)))
    }

    //      0123456789
    case!{ parse_type_ref "&[sc; 207]", |x|
        make_type!(x ref 0:9
            make_type!(x array 1:9
                make_type!(x simple 2:3 #sc),
                make_expr!(x i32 207 6:8))),
    }
}
    ...
    case!{ parse_path(TYPE) "a<b, c, d>", |x|
        make_path!(x 0:9
            make_path!(x segment generic 0:9 #a 0:0 quote 1:9
                ...
                make_type!(x path 5:5
                    make_path!(x segment simple 5:5 #c)),
                make_type!(x path 8:8
    ...
    case!{ parse_path(VALUE) "a::<b, c, d>", |x|
        make_path!(x 0:11
            make_path!(x segment generic 0:11 #a 0:0 quote 3:11
                ...
                make_type!(x path 7:7
                    make_path!(x segment simple 7:7 #c)),
                make_type!(x path 10:10

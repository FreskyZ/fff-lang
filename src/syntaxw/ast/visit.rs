...
impl<'a> Visit for ArrayIndexExpr<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        v.visit_expr(arena.get(&self.base), arena)?;
...
impl<'a> Visit for ArrayType<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        v.visit_type_ref(arena.get(&self.base), arena)?;
        v.visit_expr(arena.get(&self.size), arena)
    }
}
...
impl<'a> Visit for AssignExprStatement<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        v.visit_expr(arena.get(&self.left), arena)?;
        v.visit_expr(arena.get(&self.right), arena)
    }
}
...
impl<'a> Visit for CastSegment<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        v.visit_type_ref(arena.get(&self.left), arena)?;
        v.visit_type_ref(arena.get(&self.right), arena)
    }
}
...
impl<'a> Visit for ClassDef<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        ...
        for r#type in arena.get_iter(&self.types) {
            v.visit_type_def(r#type, arena)?;
        }
        for function in arena.get_iter(&self.functions) {
            v.visit_fn_def(function, arena)?;
        }
        Default::default()
    }
}
...
impl<'a> Visit for EnumDefVariant<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        if let Some(value) = &self.value {
            v.visit_expr(arena.get(value), arena)?;
        }
        Default::default()
    }
}
...
impl<'a> Visit for FieldDef<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        v.visit_type_ref(arena.get(&self.r#type), arena)
    }
}
...
impl<'a> Visit for FnDef<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        ...
        if let Some(ret_type) = &self.ret_type {
            v.visit_type_ref(arena.get(ret_type), arena)?;
        }
...
impl<'a> Visit for ForStatement<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        v.visit_expr(arena.get(&self.iter_expr), arena)?;
        v.visit_block(arena.get(&self.body), arena)
    }
}
...
impl<'a> Visit for IfClause<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        v.visit_expr(arena.get(&self.condition), arena)?;
        v.visit_block(arena.get(&self.body), arena)
    }
}
...
impl<'a> Visit for Implementation<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        ...
        if let Some(class) = &self.class {
            v.visit_type_ref(arena.get(class), arena)?;
        }
        v.visit_type_ref(arena.get(&self.r#type), arena)?;
        for r#where in arena.get_iter(&self.wheres) {
            v.visit_where_clause(r#where, arena)?;
...
impl<'a> Visit for ObjectExprField<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        v.visit_expr(arena.get(&self.value), arena)
    }
}
...
impl<'a> Visit for SimpleExprStatement<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        v.visit_expr(arena.get(&self.expr), arena)
    }
}
...
impl<'a> Visit for TypeDef<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        ...
        if let Some(from) = &self.from {
            v.visit_type_ref(arena.get(from), arena)?;
        }
        Default::default()
    }
}
...
impl<'a> Visit for VarDeclStatement<'a> {
    ...
    fn walk<V: Visitor>(&self, arena: &Arena, v: &mut V) -> V::Result {
        if let Some(r#type) = &self.r#type {
            v.visit_type_ref(arena.get(r#type), arena)?;
        }
        if let Some(init_value) = &self.init_value {
            v.visit_expr(arena.get(init_value), arena)?;
        }
        Default::default()
    }
}

...
pub mod asti {
    ...
    // pub use super::pretty::display;
    // pub use super::profile::profile;
}
// except lit value can be regarded as a node type
pub use na::LitValue;
...
pub struct ArrayType<'a> {
    pub span: Span,
    pub base: Index<'a, TypeRef<'a>>,
    pub size: Index<'a, Expr<'a>>,
}

pub struct AssignExprStatement<'a> {
    pub span: Span,
    pub left: Index<'a, Expr<'a>>,
    pub right: Index<'a, Expr<'a>>,
    pub op: Separator,
    pub op_span: Span,
}
...
pub struct CastSegment<'a> {
    pub span: Span,
    pub left: Index<'a, TypeRef<'a>>,
    pub right: Index<'a, TypeRef<'a>>,
}
...
pub struct ClassDef<'a> {
    ...
    pub quote_span: Span,
    pub types: Slice<'a, TypeDef<'a>>,
    pub functions: Slice<'a, FnDef<'a>>,
}
...
pub struct EnumDefVariant<'a> {
    pub span: Span,
    pub name: IdSpan,
    pub value: Option<Index<'a, Expr<'a>>>,
}
...
pub struct FnDef<'a> {
    ...
    pub ret_type: Option<Index<'a, TypeRef<'a>>>,
...
pub struct Implementation<'a> {
    pub span: Span,
    pub parameters: Slice<'a, GenericParameter>,
    pub class: Option<Index<'a, TypeRef<'a>>>,
    pub r#type: Index<'a, TypeRef<'a>>,
    pub wheres: Slice<'a, WhereClause<'a>>,
    pub quote_span: Span,
    pub types: Slice<'a, TypeDef<'a>>,
...
pub struct TypeDef<'a> {
    pub span: Span,
    pub name: Index<'a, GenericName<'a>>,
    pub from: Option<Index<'a, TypeRef<'a>>>,
}
...
pub struct VarDeclStatement<'a> {
    ...
    pub r#const: bool,
    pub name: IdSpan,
    pub r#type: Option<Index<'a, TypeRef<'a>>>,
    pub init_value: Option<Index<'a, Expr<'a>>>,
}

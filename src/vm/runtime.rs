...
impl RuntimeValue {
    ...
    pub fn from_lit(lit: &LitValue) -> RuntimeValue {
        match lit {
            ...
            &LitValue::Num(Some(NumLitValue::I8(ref value))) => RuntimeValue::I8(*value),
            &LitValue::Num(Some(NumLitValue::U8(ref value))) => RuntimeValue::U8(*value),
            &LitValue::Num(Some(NumLitValue::I16(ref value))) => RuntimeValue::I16(*value),
            &LitValue::Num(Some(NumLitValue::U16(ref value))) => RuntimeValue::U16(*value),
            &LitValue::Num(Some(NumLitValue::I32(ref value))) => RuntimeValue::I32(*value),
            &LitValue::Num(Some(NumLitValue::U32(ref value))) => RuntimeValue::U32(*value),
            &LitValue::Num(Some(NumLitValue::I64(ref value))) => RuntimeValue::I64(*value),
            &LitValue::Num(Some(NumLitValue::U64(ref value))) => RuntimeValue::U64(*value),
            &LitValue::Num(Some(NumLitValue::F32(ref value))) => RuntimeValue::R32(*value),
            &LitValue::Num(Some(NumLitValue::F64(ref value))) => RuntimeValue::R64(*value),
            _ => unreachable!(),
        }
    }

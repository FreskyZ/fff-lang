...
fn expr_expand(gener: &mut FunctionGenerater, expr: Expression) -> Vec<VMCode> {
    Vec::new()
}

pub fn expr_stmt_expand(gener: &mut FunctionGenerater, expr_stmt: &ExpressionStatement) -> Vec<VMCode> {

...
const KINDS: &[u8] = &[
    ...
    3, 3, 3, 3, 3, 1, 3, 3, 2, 3, 3, 3, 1, 3, 3, 1, 3, 1, 3, 3, 3, 2, 2, 2, 2, 3,
    1, 1, 3, 3, 1, 3,
];
...
const BUCKETS: &[&[&[Option<Keyword>]]] = &[&[], &[],
    ...
    /* 6 */ &[
        &[
            None, Some(Typeof), Some(Bits64), Some(Struct), Some(Unsafe), Some(Return),
            Some(Module), Some(Extern), Some(Static), None, Some(String), Some(Bits16),
            None, None,
        ],
        &[
            None, None, None, None, None, None, None, None, Some(Switch), None, Some(Public),
            Some(Bits32), None, None,
        ],
    ],
    /* 7 */ &[
        &[

...
const VALUES: &[&str] = &[
    ...
    "i16", "i32", "i64", "i8", "if", "impl", "import", "in", "interface", "internal",
    "is", "let", "loop", "match", "module", "mut", "namespace", "null", "or", "override",
    "private", "protected", "pub", "public", "r128", "r32", "r64", "ref", "ret",
    "return", "self", "static", "string", "struct", "super", "switch", "this", "throw",
    "trait", "true", "try", "type", "typedef", "typeof", "u128", "u16", "u32", "u64",
    "u8", "unsafe", "use", "var", "virtual", "volatile", "while", "yield",
];
const KINDS: &[u8] = &[
    0, 1, 3, 1, 3, 3, 3, 3, 3, 3, 2, 1, 3, 2, 3, 1, 1, 1, 3, 3, 3, 2, 2, 1, 3, 1,
    1, 3, 3, 2, 2, 2, 2, 1, 3, 1, 1, 3, 3, 3, 3, 1, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,
    3, 3, 3, 3, 3, 3, 1, 3, 3, 2, 3, 3, 3, 1, 3, 3, 1, 3, 1, 3, 3, 3, 2, 2, 2, 2,
    3, 1, 1, 3, 3, 1, 3,
];
...
const BUCKETS: &[&[&[Option<Keyword>]]] = &[&[], &[],
    ...
    /* 6 */ &[
        &[
            None, None, None, Some(Bits16), Some(Public), Some(Struct), Some(String),
            Some(Extern), Some(Unsafe), None, Some(Import), Some(Return), Some(Bits64),
            None, None, None, Some(Module), None,
        ],
        &[
            None, None, None, Some(Bits32), Some(Static), None, None, Some(Typeof),
            None, None, Some(Switch), None, None, None, None, None, None, None,
        ],
    ],
    /* 7 */ &[
        &[

...
fn unary_expr_parse() {
    ...
    assert_eq!{ UnaryExpr::with_test_str("1"), 
        UnaryExpr::new_primary(PrimaryExpr::Lit(LitExpr::new(LitValue::from(1), make_span!(0, 0)))) 
    }
        ...
        UnaryExpr::new_unary(
            ...
            UnaryExpr::new_unary(
                ...
                UnaryExpr::new_unary(
                    ...
                    UnaryExpr::new_primary(PrimaryExpr::Lit(LitExpr::new(LitValue::from(1), make_span!(3, 3)))),
                )
            )
        )
    }
